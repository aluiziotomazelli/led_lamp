...
//};
//
//// Efeitos dummy para teste
//static effect_param_t dummy_params[] = {
//    {"Hue", 120, 0, 360, 1},
//    {"Sat", 255, 0, 255, 1}
//};
//
...
//      {
//        .name = "dummy",
//        .id = 2, // Unique ID for "Candle"
//        .param_count = sizeof(dummy_params) / sizeof(effect_param_t),
//        .params = dummy_params // Pointer to its default parameters
//    }
//    // To add more effects:
